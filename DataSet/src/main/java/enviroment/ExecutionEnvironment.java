...
public class ExecutionEnvironment {
    ...
    public static ExecutionEnvironment getExecutionEnvironment() {
        return contextEnvironmentFactory == null ?
                new ExecutionEnvironment() : contextEnvironmentFactory.createExecutionEnvironment();
    }

    public final <T> DataSource<T> fromCollection(Collection<T> data) {
        return new DataSource<T>(data);
    }

    public final <T> DataSource<T> fromElement(T... data) {
        if (data == null) {
